...
# ingredient normalization service settings
INGREDIENT_NORMALIZATION_AMOUNT_DECIMAL_PLACES = int(os.getenv('INGREDIENT_NORMALIZATION_AMOUNT_DECIMAL_PLACES', 4))
INGREDIENT_NORMALIZATION_ENABLE_AUTOMATIONS = extract_bool('INGREDIENT_NORMALIZATION_ENABLE_AUTOMATIONS', True)
INGREDIENT_NORMALIZATION_USE_CACHE = extract_bool('INGREDIENT_NORMALIZATION_USE_CACHE', True)
INGREDIENT_NORMALIZATION_MAX_FOOD_NAME_LENGTH = int(os.getenv('INGREDIENT_NORMALIZATION_MAX_FOOD_NAME_LENGTH', 128))
INGREDIENT_NORMALIZATION_MAX_NOTE_LENGTH = int(os.getenv('INGREDIENT_NORMALIZATION_MAX_NOTE_LENGTH', 256))
INGREDIENT_NORMALIZATION_MERGE_NOTES = extract_bool('INGREDIENT_NORMALIZATION_MERGE_NOTES', True)
INGREDIENT_NORMALIZATION_AUTO_UNIT_CONVERSION = extract_bool('INGREDIENT_NORMALIZATION_AUTO_UNIT_CONVERSION', False)
INGREDIENT_NORMALIZATION_PREFERRED_UNITS = extract_comma_list('INGREDIENT_NORMALIZATION_PREFERRED_UNITS', '')
INGREDIENT_NORMALIZATION_ENABLE_MULTILINGUAL = extract_bool('INGREDIENT_NORMALIZATION_ENABLE_MULTILINGUAL', True)
INGREDIENT_NORMALIZATION_FALLBACK_ENABLED = extract_bool('INGREDIENT_NORMALIZATION_FALLBACK_ENABLED', True)
INGREDIENT_NORMALIZATION_FALLBACK_ROLLBACK_ON_ERROR = extract_bool('INGREDIENT_NORMALIZATION_FALLBACK_ROLLBACK_ON_ERROR', True)
INGREDIENT_NORMALIZATION_GRAYSCALE_PERCENT = int(os.getenv('INGREDIENT_NORMALIZATION_GRAYSCALE_PERCENT', 100))
INGREDIENT_NORMALIZATION_LOG_COMPARISON = extract_bool('INGREDIENT_NORMALIZATION_LOG_COMPARISON', False)
INGREDIENT_NORMALIZATION_CACHE_TTL = int(os.getenv('INGREDIENT_NORMALIZATION_CACHE_TTL', 86400))
INGREDIENT_NORMALIZATION_CACHE_VERSION = int(os.getenv('INGREDIENT_NORMALIZATION_CACHE_VERSION', 1))
INGREDIENT_NORMALIZATION_NLP_CHINESE_BACKEND = os.getenv('INGREDIENT_NORMALIZATION_NLP_CHINESE_BACKEND', 'auto')
INGREDIENT_NORMALIZATION_NLP_JAPANESE_BACKEND = os.getenv('INGREDIENT_NORMALIZATION_NLP_JAPANESE_BACKEND', 'auto')
