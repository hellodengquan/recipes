...
PERMISSION_AUDIT_LOG_RETENTION_DAYS = int(os.getenv('PERMISSION_AUDIT_LOG_RETENTION_DAYS', 365))
PERMISSION_AUDIT_LOG_BATCH_SIZE = int(os.getenv('PERMISSION_AUDIT_LOG_BATCH_SIZE', 1000))
