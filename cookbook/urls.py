...
urlpatterns = [
    ...
    path('api/nutrition-review/summary/', api.NutritionReviewSummaryView.as_view(), name='api_nutrition_review_summary'),
    path('api/nutrition-review/pending/', api.NutritionReviewPendingView.as_view(), name='api_nutrition_review_pending'),
    path('api/nutrition-review/batch-approve/', api.NutritionReviewBatchApproveView.as_view(), name='api_nutrition_review_batch_approve'),
    path('api/nutrition-review/batch-reject/', api.NutritionReviewBatchRejectView.as_view(), name='api_nutrition_review_batch_reject'),
    path('api/nutrition-review/batch-flag/', api.NutritionReviewBatchFlagView.as_view(), name='api_nutrition_review_batch_flag'),
